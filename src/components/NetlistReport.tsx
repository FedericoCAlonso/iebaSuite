...
export function NetlistReport({ project, ambiente, onClose }: { project: Project, ambiente: Ambiente, onClose: () => void }) {
  ...
  return (
    <div className="dialog-overlay">
      <div className="dialog" style={{ maxWidth: '800px', width: '90%' }}>
        <div className="dialog-header">
          <span className="dialog-title">Reporte de Materiales: {ambiente.nombre}</span>
          <button className="btn btn-ghost" onClick={onClose}>✕</button>
        </div>
        
        <div className="dialog-content" style={{ maxHeight: '70vh', overflowY: 'auto' }}>
          <h4>Bocas y Elementos Eléctricos</h4>
          ...
          <h4>Conexiones y Canalizaciones</h4>
